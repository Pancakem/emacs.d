;;; init.el --- Pancakem's Emacs configuration
;;
;; Copyright (c) 2022 Marvin Ouma
;;
;; Author: Marvin Ouma <pancakesdeath(a)protonmail.com>
;; License: Apache-2.0
;;
;; https://github.com/pancakem/emacs.d
;;
;;; Code:
...
(setq user-full-name "Marvin Ouma"
      user-mail-address "pancakesdeath@protonmail.com")
...
(setq dashboard-banner-logo-title "I just had a wonderful thought.")
(setq dashboard-footer-messages '("It is gone!")
      )
;;; built-in packages
(use-package paren
  :config
